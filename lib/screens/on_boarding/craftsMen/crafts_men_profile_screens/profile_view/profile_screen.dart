...
class CraftsMenProfileScreen extends ConsumerStatefulWidget {
  const CraftsMenProfileScreen({Key? key}) : super(key: key);
  static const String id = 'profileScrren';

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _CraftsMenProfileScreenState();
}

class _CraftsMenProfileScreenState extends ConsumerState<CraftsMenProfileScreen> {
  bool readOnly = true;
  bool onEdit = false;
